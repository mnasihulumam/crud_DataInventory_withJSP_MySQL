<%-- 
    Document   : tambah_pegawai
    Created on : Dec 7, 2020, 11:38:52 AM
    Author     : HP
--%>
...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("INSERT INTO data_pegawai(nama_pegawai,jk,jabatan,tempat_lahir,tanggal_lahir,agama,no_hp,alamat)values(?,?,?,?,?,?,?,?)");
          ...
          <div class="container-fluid" style="padding-bottom: 450px;">
            ...
            <hr class="bg-secondary"></hr>
              <form method="post" action="#">
                    ...
                    <div class="form-group">
                      <button type="submit" name="submit" class="btn btn-primary">Submit</button> <button class="btn btn-warning"><a href="tampil_pegawai.jsp" style="text-decoration: none;">Kembali</a></button>
                    </div>
              </form>
          </div>
        </div>
